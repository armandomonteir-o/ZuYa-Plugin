...
setup_nestjs() {
  ...
  # Criar projeto NestJS (adicionar --yes)
  npx --yes @nestjs/cli new "$dir_name" --package-manager npm --strict --skip-git || { echo "❌ Falha ao criar projeto NestJS."; return 1; } # --skip-git porque já inicializamos
